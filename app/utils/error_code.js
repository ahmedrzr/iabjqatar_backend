...
exports = USER_ERROR_CODE = {
    ...
    ADD_FAVOURITE_ZONE_FAILED: 9009,
    FAVOURITE_STORE_LIST_NOT_FOUND: 9010,
    //favouritecity
    ADD_FAVOURITE_CITY_FAILED: 9011,
    FAVOURITE_CITY_LIST_NOT_FOUND: 9012,
    //favouritecity
    ...
    ADD_ADDRESS_FAILED:562,
    UPDATE_ADDRESS_FAILED:563,
    GET_ADDRESS_FAILED:564,
    DELETE_ADDRESS_FAILED:565,
    GET_SETTING_FAILED:566,
    UPDATE_SETTING_FAILED:567,
    PHONE_NUMBER_NOT_FOUND: 568,
    ORDER_UPDATE_FAILED:569,
    DEVICE_NOT_ALLOWED:570,
    PAYMENT_GATEWAY_NOT_ALLOWED:571,
    SPECIAL_OFFER_IS_NOT_VALID:572,
    HAPPY_HOUR_IS_NOT_VALID:573,
    OUT_OF_DELIVERY_AREA:577,
    ALERT_ALREADY_ADDED:578,
    ADD_ALERT_FAILED:579,
};
...
exports = STORE_ERROR_CODE = {
    ...
    MAXIMUM_LIMIT_OF_PROMOCODE_IS_REACHED: 501,
    ...
    CUISINE_ADD_FAILED : 648,
    STORE_UPLOAD_IMAGE_FAILED : 649,
    STORE_IS_BUSY : 650,
    STORE_IS_BUSY_YOU_CAN_NOT_CREATE_ASAP_ORDER : 651,
    SUPPLIER_ADD_FAILED : 700,
};
...
exports = ORDER_ERROR_CODE = {
    ...
    ORDER_NOT_READY:661,
    ORDER_IS_NOT_VERIFIED:662,
    ORDER_APPROVE_FAILED:663
};
...
exports = CART_ERROR_CODE = {
    ...
    INVALID_ITEM_QUANTITY:574,
    ITEMS_NOT_AVAILABLE_FOR_PICKUP:575,
    ITEMS_NOT_AVAILABLE_FOR_DELIVERY:576,
...
exports = DISTRICT_ERROR_CODE = {
    DISTRICT_DETAILS_NOT_FOUND: 1101,
    DISTRICT_ADD_FAILED: 1102,
    UPDATE_FAILED: 1103,
    DISTRICT_NOT_FOUND: 1104,
};

exports = PAGE_ERROR_CODE = {
    PAGE_DETAILS_NOT_FOUND: 1201,
    PAGE_ADD_FAILED: 1202,
    UPDATE_FAILED: 1203,
    PAGE_NOT_FOUND: 1204,
    PAGE_DELETE_FAILED: 1205,
};
...
exports = SETTING_ERROR_CODE = {
    ...
    LANGUAGE_DETAILS_NOT_FOUND: 834,
    LANGUAGE_ADD_FAILED:835
};
...
exports = ITEM_ERROR_CODE = {
    ...
    ITEM_NOT_AVAILABLE_FOR_CART: 898,
    ITEM_DELETE_FAILED: 899,
};
...
exports = CARD_ERROR_CODE = {
    ...
    fAILED_TO_GENERATE_CHECKOUT_ID: 1020
};
...
exports = ADMIN_ERROR_CODE = {
    ...
    NOTIFICATION_DATA_NOT_FOUND: 997,
    ROLE_NAME_ALREADY_REGISTERED: 998
};

exports = FRANCHISE_ERROR_CODE = {
    UPDATE_FAILED: 1350,
    PHONE_NUMBER_ALREADY_REGISTRED: 1351,
};

exports = CDCMS_ERROR_CODE = {
    EMAIL_ALREADY_REGISTERED: 1400,
    ADD_FAILED: 1401,
    DATA_NOT_FOUND: 1402,
    DETAIL_NOT_FOUND: 1403,
    UPDATE_FAILED: 1404,
    DELETE_FAILED: 1405
};
